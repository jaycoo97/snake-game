...
# Defining and creating the main classes of food and snake
class Snake:
    def __init__(self):
...
# Implementation of different snake movements
...
# Snake direction changes settings
...
# Show that you lost and then start working again
def game_over():
    canvas.delete(ALL)
...
#---------------------------------------------
# Settings of screen dimensions, snake speed, snake color, etc.
GAME_WITH = 700
GAME_HEIGHT = 700
SPACE_SIZE = 25
SLOWNESS  = 200
...
# The main settings of the TK package and program execution
window = Tk()
